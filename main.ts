...
namespace LEDBit {
    ...
    const num41: number[] = [0x0, 0x1, 0x0, 0x1, 0x80, 0x1, 0x40, 0x1, 0x20, 0x7, 0xf0, 0x1, 0x0, 0x1, 0x0, 0x1, 0x0];
    ...
    const num01: number[] = [0x0, 0x1, 0xc0, 0x2, 0x20, 0x2, 0x20, 0x2, 0x20, 0x2, 0x20, 0x2, 0x20, 0x2, 0x20, 0x1, 0xc0];
	

    export enum numExpression_o {
        //% blockId="numo_FACE1" block="num1"
        numo_FACE1 = 0,
        //% blockId="numo_FACE2" block="num2"
        numo_FACE2,
        //% blockId="numo_FACE3" block="num3"
        numo_FACE3,
        //% blockId="numo_FACE4" block="num4"
        numo_FACE4,
        //% blockId="numo_FACE5" block="num5"
        numo_FACE5,
        //% blockId="numo_FACE6" block="num6"
        numo_FACE6,
        //% blockId="numo_FACE7" block="num7"
        numo_FACE7,
        //% blockId="numo_FACE8" block="num8"
        numo_FACE8,
        //% blockId="numo_FACE9" block="num9"
        numo_FACE9,
        //% blockId="numo_FACE0" block="num0"
        numo_FACE0,
    }
	
    const num11_o: number[] = [0x8, 0xC, 0x8, 0x8, 0x8, 0x8, 0x8, 0x3E];
    const num21_o: number[] = [0x38, 0x44, 0x40, 0x20, 0x10, 0x8, 0x4, 0x7E];
    const num31_o: number[] = [0x38, 0x44, 0x40, 0x30, 0x40, 0x40, 0x44, 0x38];
    const num41_o: number[] = [0x10, 0x18, 0x14, 0x12, 0x7F, 0x10, 0x10, 0x10];
    const num51_o: number[] = [0x3E, 0x2, 0x1E, 0x20, 0x20, 0x20, 0x22, 0x1C];
    const num61_o: number[] = [0x38, 0x4, 0x2, 0x3E, 0x42, 0x42, 0x42, 0x3C];
    const num71_o: number[] = [0x7E, 0x40, 0x20, 0x10, 0x8, 0x4, 0x2, 0x0];
    const num81_o: number[] = [0x3C, 0x42, 0x42, 0x3C, 0x42, 0x42, 0x42, 0x3C];
    const num91_o: number[] = [0x3C, 0x42, 0x42, 0x42, 0x7C, 0x40, 0x42, 0x3C];
    const num01_o: number[] = [0x3C, 0x42, 0x42, 0x42, 0x42, 0x42, 0x42, 0x3C];
    ...
    //% blockId=ledbit_led_num block="LED num Show|%n"
    //% n.min=0 n.max=99 
    //% weight=96
    export function LEDnum(n: number): void {
        if (!initMatrix) {
            matrixInit();
            initMatrix = true;
        }
		if(n < 10 && n >= 0) {
			switch (n) {
				...
				case 0: {
					...
					pins.i2cWriteBuffer(HT16K33_ADDRESS, num0);
					break;
				}
				default: {
					break;
			...
			let n2 = n%10;
			let num_o = pins.createBuffer(17);
			let sum_t=0;
			num_o[0] = 0x00;
			...
			pins.i2cWriteBuffer(HT16K33_ADDRESS, num_o);
		}
    }
